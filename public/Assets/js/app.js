  ...
  async function videoProcess(newVideoState) {
    if (newVideoState == video_states.None) {
      ...
      $("#ScreenShareOnOf").html(
        '<span class="material-icons">present_to_all</span><div>Демонстрация</div>'
      );
...
var MyApp = (function () {
  ...
  $(document).on("click", ".end-call-wrap ", function () {
    $(".top-box-show")
      ...
      .html(
        ' <div class ="top-box align-vertical-middle profile-dialogue-show"> <h3 class="mt-3" style="text-align:center; font-size: 32px; color: #1A2C22;"> Покинуть конференцию </h3> <div class="call-leave-cancel-action d-flex justify-content-center align-items-center w-100"> <a href="/action.html"><button class="call-leave-action btn btn-danger mr-2"> Покинуть </button></a> <button class="call-cancel-action btn btn-secondary"> Отмена </button> </div> </div>'
      );
  });
  ...
  async function startRecording() {
    ...
    mediaRecorder.onstop = function (e) {
      var clipName = prompt("Введите имя записи");
